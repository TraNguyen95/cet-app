...
import image from '../../assets/images/portback.png'
...
export const SliderComponent = () => {
  ...
  return (
    <>
      <div className='slider-item flex items-center justify-items-center' style={style}>
        <div className='slider-text-left flex h-full items-center'>
          <div className='flex w-2/3 flex-col'>
            ...
            <span className='text-small break-words text-white'>
              10ヶ月（要件定義～納品） FLUTTER,node.js,FIREBASE,AWS,agora.io <br />
              50時間 <br />
