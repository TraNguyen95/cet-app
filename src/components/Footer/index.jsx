        ...
        <div className='flex flex-wrap items-center'>
          <div className='basis-2/3 max-md:w-full max-md:basis-full'>
            <div className='flex flex-wrap'>
              ...
              <div
                className='mt-[80px] flex basis-1/2 items-center gap-3 max-lg:mt-[30px] max-md:hidden max-md:basis-full'>
              ...
              <div
                className='mt-[80px] flex basis-1/2 items-center gap-3 max-lg:mt-[30px] max-md:basis-full min-[768px]:hidden'>
                <Link to='/contact' className='h-10 w-10'>
                  <img className='max-[500px]:h-10 max-[500px]:w-10' src={iconRow} alt=''/>
                </Link>
                <span className='opacity-60'>CONTACT NOW</span>
